...
public class ActivityThread extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener, OnMapReadyCallback {
    private Fonts fonts;
        ...
        api.getActivity(new WallaApi.OnDataReceived() {
            ...
            public void onDataReceived(Object data, int call) {
                ...
                try {
                    ...
                    Toast.makeText(ActivityThread.this, e.toString(), Toast.LENGTH_LONG).show();
                }
            }
        }, auid);
    }
    ...
    private void initUi() {
        ...
        if(event.isDeleted()){
            ...
            AlertDialog.Builder alertOfDelete = new AlertDialog.Builder(ActivityThread.this);
                    ...
                    api.isUserSuspended(new WallaApi.OnDataReceived() {
                        ...
                        public void onDataReceived(Object data, int call) {
                            ...
                            if(!isSuspended){
                                ...
                                Message info = new Message(auth.getCurrentUser().getUid(), message);
    ...
    private void loadComments(){
        api.getComments(new WallaApi.OnDataReceived() {
            @Override
            public void onDataReceived(Object data, int call) {
                List<Message> list = (List<Message>) data;
    ...
    private View getComment(final Message info){
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ActivityThread.this, ViewProfile.class);
                ...
                storage.getReferenceFromUrl(url).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            Picasso.with(ActivityThread.this) //Context
    ...
    private void deleteActivity(){
        AlertDialog.Builder confirmDelete = new AlertDialog.Builder(ActivityThread.this);
