...
public class NotificationInfoLVAdapter extends ArrayAdapter<NotificationInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(!notification.isRead()){
            changeBackGroundColor(container, getContext().getResources().getColor(R.color.notificationBlue));
        }

        switch(notification.getType()){
            case Notifications.FRIEND_REQUEST:
                changeBackGroundColor(accept, getContext().getResources().getColor(R.color.lightBlue));
                changeBackGroundColor(ignore, getContext().getResources().getColor(R.color.lightGray));
            ...
            case Notifications.GROUP_INVITED:
                ...
                container.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(getContext(), ActivityThread.class);
